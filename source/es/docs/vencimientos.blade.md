...
## Ejemplo API: Crear vencimiento periodico
...

{
  ...
  "category_id": 5,
  "tags": ["streaming", "suscripciones"],
  "external_id": "NFLX-123"
}
```

## Ejemplo API: Crear vencimiento personalizado (plan de cuotas)
