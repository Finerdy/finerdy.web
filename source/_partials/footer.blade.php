    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center gap-8 md:flex-row md:justify-between">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="https://www.instagram.com/finerdy.app" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-primary-600 transition-colors" aria-label="Instagram">
